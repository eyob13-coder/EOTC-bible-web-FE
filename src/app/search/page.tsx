        ...
        <div className="mx-auto max-w-6xl px-4 py-4">
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <select
              ...
              className="rounded border border-gray-300 px-3 py-1 text-sm hover:border-gray-400 focus:border-[#4C0E0F] focus:outline-none dark:border-neutral-700 dark:bg-neutral-800 dark:text-gray-200 dark:hover:border-neutral-600"
            >
      ...
      <div className="mx-auto max-w-6xl px-4 py-6">
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-4">
          <div className="lg:col-span-1">
            <div className="sticky top-32 rounded-lg border bg-white p-4 dark:border-neutral-700 dark:bg-neutral-800">
              <h3 className="mb-3 flex items-center gap-2 font-semibold text-gray-900 dark:text-white">
                <BookOpen size={18} className="text-[#4C0E0F] dark:text-red-400" />
                Verses by Book
              </h3>
              {isLoading ? (
              ...
              {selectedBook && (
                <button
                  ...
                  className="mt-3 text-sm font-medium text-[#4C0E0F] hover:text-red-700 dark:text-red-400 dark:hover:text-red-300"
                >
                  Clear book filter
                </button>
              )}
            ...
            {isLoading ? (
              <div className="rounded-lg border bg-white p-8 text-center dark:border-neutral-700 dark:bg-neutral-800">
                <div className="inline-block">
                  <div className="h-8 w-8 animate-spin rounded-full border-2 border-[#4C0E0F] border-t-transparent dark:border-red-400 dark:border-t-transparent"></div>
                </div>
                <p className="mt-4 text-gray-600 dark:text-gray-300">Searching Bible...</p>
              </div>
            ) : results.length === 0 ? (
              <div className="rounded-lg border bg-white p-8 text-center dark:border-neutral-700 dark:bg-neutral-800">
              ...
              <div className="rounded-lg border bg-white dark:border-neutral-700 dark:bg-neutral-800">
                <div className="flex items-center justify-between border-b bg-gray-50 px-4 py-3 dark:border-neutral-700 dark:bg-neutral-900/50">
                  <span className="text-sm text-gray-600 dark:text-gray-300">
                    Showing {displayedResults.length} of {results.length} results
                    {selectedBook && (
                      <span className="ml-2 text-[#4C0E0F] dark:text-red-400">
                ...
                <div className="divide-y dark:divide-neutral-700">
                  {displayedResults.map((result, idx) => (
                    <div
                      ...
                      className="cursor-pointer border-l-4 border-l-transparent p-4 transition-colors hover:border-l-[#4C0E0F] hover:bg-red-50 dark:hover:border-l-red-500 dark:hover:bg-neutral-700"
                    >
                      {result.type === 'book' ? (
                ...
                {hasMore && (
                  <div className="border-t bg-gray-50 p-4 dark:border-neutral-700 dark:bg-neutral-900/50">
                    <button
